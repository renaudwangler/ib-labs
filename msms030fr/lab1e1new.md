...
Si votre navigateur le supporte, vous pouvez <a href="#" onclick="document.getElementById('domainInput').style.display = 'block';return false">cliquer sur ce lien</a> pour personnalisé les noms de domaines dans ces instructions et vous en faciliter l'utilisation tout au long de votre stage.  
