...
domainInput.style.cssText = 'width:50%; background:white; border:solid 2px blue; position:fixed; top:25%; left:25%;'
...
domainInputContent.innerHTML = 'Ici, vous pouvez saisir les noms de domaine de votre instance d\'atelier afin de vous en faciliter la réalisation.<br/><ul><li>Domaine original Microsoft 365 :<br/><input type="text" id="onmicrosoftDomain" value="' + onmicrosoftDomain + '">.onmicrosoft.com</li><li>Domaine de l\'atelier goDeploy :<br/>' + godeployDomain + '.godeploylabs.com</li></ul>'
